...
func init() {
	m.Register(func(db dbx.Builder) error {
		...
		// remove
		collection.Schema.RemoveField("l6pyaenp")

		// remove
		collection.Schema.RemoveField("ghad7byt")

		// remove
		collection.Schema.RemoveField("dlmfwq0p")
